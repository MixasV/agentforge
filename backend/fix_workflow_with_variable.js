...
async function fixWorkflow() {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          icon: '💬',
          config: {
            botToken: '{{telegram_trigger.botToken}}',
  ...
  console.log('✅ Fixed with botToken from Variables!');
